...
export type FindProjectsQuery = {
  ...
  findProjects: Array<{
    ...
    updatedAt: any;
    createdAt: any;
    current_archive_name?: string | null;
...
export type FindArchivesQuery = {
  __typename?: "Query";
  findArchives: Array<{
    __typename?: "Archive";
    id: string;
    name: string;
    project: { __typename?: "Project"; name_ar: string; id: string };
  }>;
};
  ...
  findArchive: {
    ...
    levels: Array<{
      ...
      divisions?: Array<{
        ...
        name: string;
        id: string;
        students: Array<{ __typename?: "Student"; name: string; id: string }>;
        employees?: Array<{
          __typename?: "Student";
          name: string;
          id: string;
...
export type CreateDivisionMutation = {
  __typename?: "Mutation";
  createDivision: { __typename?: "Division"; id: string; name: string };
};
...
export type FindEmployeesQuery = {
  __typename?: "Query";
  findEmployees: Array<{ __typename?: "Employee"; name: string; id: string }>;
};
...
export type CreateLevelMutation = {
  __typename?: "Mutation";
  createLevel: { __typename?: "Level"; id: string; name: string };
};
...
export type Find_Levels_DivisionsQuery = {
  __typename?: "Query";
  find_levels_divisions: Array<{
    __typename?: "Level";
    id: string;
    name: string;
    archive: {
...
export type Find_Levels_Divisions_Employees_StudentsQuery = {
  __typename?: "Query";
  find_levels_divisions_employees_students: Array<{
    __typename?: "Level";
    id: string;
    name: string;
    archive: {
    ...
    divisions?: Array<{
      ...
      employees?: Array<{ __typename?: "Student"; id: string }> | null;
    }> | null;
  }>;
};
...
export type Find_Levels_Divisions_StudentsQuery = {
  __typename?: "Query";
  find_levels_divisions_students: Array<{
    __typename?: "Level";
    id: string;
    name: string;
    archive: {
...
export type Find_Levels_Divisions_EmployeesQuery = {
  __typename?: "Query";
  find_levels_divisions_employees: Array<{
    __typename?: "Level";
    id: string;
    name: string;
    archive: {
...
export type FindSemestersQuery = {
  __typename?: "Query";
  findSemesters: Array<{ __typename?: "Semester"; id: string; name: string }>;
};
...
>(
  ...
  useQuery<FindProjectsQuery, TError, TData>(
    ...
    fetcher<FindProjectsQuery, FindProjectsQueryVariables>(
      client,
...
>(
  ...
  useQuery<FindArchivesQuery, TError, TData>(
    ...
    fetcher<FindArchivesQuery, FindArchivesQueryVariables>(
      client,
      FindArchivesDocument,
      variables,
      headers
    ),
    options
...
export const FindArchiveDocument = `
  ...
  findArchive(archiveId: $archiveId, projectId: $projectId, sortBy: $sortBy) {
    ...
    `;
export const useFindArchiveQuery = <TData = FindArchiveQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<FindArchiveQuery, TError, TData>(
    ...
    fetcher<FindArchiveQuery, FindArchiveQueryVariables>(
      client,
      FindArchiveDocument,
      variables,
      headers
...
export const CreateDivisionDocument = `
  ...
  createDivision(input: {levelId: $levelId, name: $name}) {
    ...
    `;
export const useCreateDivisionMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
  ...
  >(
    ...
    (variables?: CreateDivisionMutationVariables) =>
      fetcher<CreateDivisionMutation, CreateDivisionMutationVariables>(
        client,
...
>(
  ...
  useQuery<FindEmployeesQuery, TError, TData>(
    ...
    fetcher<FindEmployeesQuery, FindEmployeesQueryVariables>(
      client,
      FindEmployeesDocument,
      variables,
      headers
    ),
    options
...
>(
  ...
  useQuery<FindEmployeeQuery, TError, TData>(
    ...
    fetcher<FindEmployeeQuery, FindEmployeeQueryVariables>(
      client,
...
export const FindExamsDocument = `
  ...
  findExams(semesterId: $semesterId) {
    ...
    `;
export const useFindExamsQuery = <TData = FindExamsQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<FindExamsQuery, TError, TData>(
    ["findExams", variables],
    fetcher<FindExamsQuery, FindExamsQueryVariables>(
      client,
      FindExamsDocument,
      variables,
      headers
...
export const CreateLevelDocument = `
  ...
  createLevel(input: {name: $name, archiveId: $archiveId}) {
    ...
    `;
export const useCreateLevelMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    CreateLevelMutation,
    TError,
  ...
  >(
    ["createLevel"],
    (variables?: CreateLevelMutationVariables) =>
      fetcher<CreateLevelMutation, CreateLevelMutationVariables>(
        client,
        CreateLevelDocument,
        variables,
        headers
...
>(
  ...
  useQuery<Find_Levels_DivisionsQuery, TError, TData>(
    ...
    fetcher<Find_Levels_DivisionsQuery, Find_Levels_DivisionsQueryVariables>(
      client,
      Find_Levels_DivisionsDocument,
      variables,
      headers
    ),
    options
...
>(
  ...
  useQuery<Find_Levels_Divisions_Employees_StudentsQuery, TError, TData>(
    ...
    fetcher<
      Find_Levels_Divisions_Employees_StudentsQuery,
      Find_Levels_Divisions_Employees_StudentsQueryVariables
    >(
      client,
      Find_Levels_Divisions_Employees_StudentsDocument,
      variables,
      headers
    ),
    options
...
>(
  ...
  useQuery<Find_Levels_Divisions_StudentsQuery, TError, TData>(
    ...
    fetcher<
      ...
      Find_Levels_Divisions_StudentsQueryVariables
    >(client, Find_Levels_Divisions_StudentsDocument, variables, headers),
    options
  );
...
>(
  ...
  useQuery<Find_Levels_Divisions_EmployeesQuery, TError, TData>(
    ...
    fetcher<
      Find_Levels_Divisions_EmployeesQuery,
      Find_Levels_Divisions_EmployeesQueryVariables
    >(client, Find_Levels_Divisions_EmployeesDocument, variables, headers),
    options
  );
...
>(
  ...
  useQuery<FindSemestersQuery, TError, TData>(
    ...
    fetcher<FindSemestersQuery, FindSemestersQueryVariables>(
      client,
      FindSemestersDocument,
      variables,
      headers
    ),
    options
